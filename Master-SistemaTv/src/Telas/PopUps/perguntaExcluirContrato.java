 ...
 * @author thiag
 */
public class perguntaExcluirContrato extends javax.swing.JDialog {
    int idContrato;
    JTable tabela;
    /**
     * Creates new form perguntaExcluir
     */
    public perguntaExcluirContrato(int idContrato, JTable tabela) {
        initComponents();
    ...
    private perguntaExcluirContrato() {
        initComponents();
         jPanel1.setBorder(BorderFactory.createLineBorder(Color.black));
         setModal(true);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Deseja realmente excluir o contrato selecionado?");
    ...
    private void jPanelSimMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelSimMouseClicked
        if(Contrato.removeContrato(this.idContrato)){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaExcluirContrato.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new perguntaExcluirContrato().setVisible(true);
            }
        });
    }
