 ...
 * @author Alexf
 */
public class Novo_contrato extends javax.swing.JFrame {
    JTable tabela;
    /**
     * Creates new form Janela_modelo
     */
    public Novo_contrato(String id, JTable tabela) {
        initComponents();
   ...
   public void planoIlimitado(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Novo_contrato.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Novo_contrato().setVisible(true);
            }
        });
    }
