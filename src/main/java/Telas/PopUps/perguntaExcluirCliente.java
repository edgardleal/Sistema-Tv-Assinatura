 ...
 * @author thiag
 */
public class perguntaExcluirCliente extends javax.swing.JDialog {
    JTable tabela;
    /**
     * Creates new form perguntaExcluir
     */
    public perguntaExcluirCliente() {
        initComponents();
    ...
    public perguntaExcluirCliente(JTable tab) {
        initComponents();
        jPanel1.setBorder(BorderFactory.createLineBorder(Color.black));
        this.tabela = tab;
        this.setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Deseja realmente excluir o cliente selecionado?");
    ...
    private void jPanelSimMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelSimMouseClicked
        ...
        int numero = (int) Tabela.getValueAt(Tabela.getSelectedRow(), 4);
        Cliente cliente = new Cliente(numero);
        modelo.removeRow(Tabela.getSelectedRow());
        this.dispose();
       if(Cliente.removeCliente(cliente)){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaExcluirCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
